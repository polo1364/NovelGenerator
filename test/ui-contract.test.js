...
test('service worker installs the parsed v91 application shell with pricing and generation planning before app.js', async () => {
  ...
  assert.match(sw, /const CACHE_VERSION\s*=\s*'v91';/);
